...
function getBackendUrl() {
  ...
  // For GitHub Pages, use your production backend with valid SSL certificate
...
class ProfileManager {
  ...
  getCategoryFromSubstance(substanceName) {
    ...
    const categoryMap = {
      ...
      'Propoxyphene': 'Depressants',
      'Pseudoephedrine': 'Stimulants',
  ...
  async loadSubstanceSuggestions() {
    try {
      ...
      const availableSubstances = [
        ...
        { title: 'Amyl Nitrate', category: 'Depressants', chemicalName: 'Amyl Nitrite (Isoamyl Nitrite)' },
        { title: 'Isobutyl Nitrate', category: 'Depressants', chemicalName: 'Isobutyl Nitrite' },
        ...
        { title: 'Black Tar Heroin', category: 'Depressants', chemicalName: 'Diacetylmorphine (Impure Form)' },
        ...
        { title: 'Vicodin', category: 'Depressants', chemicalName: 'Hydrocodone/Acetaminophen' },
        ...
        { title: 'Meperidine', category: 'Depressants', chemicalName: '1-Methyl-4-phenylpiperidine-4-carboxylic acid ethyl ester' },
        ...
        { title: 'Propoxyphene', category: 'Depressants', chemicalName: '(2S,3R)-1-benzyl-3-methyl-4-(methylamino)-2-phenylbutan-2-yl propanoate' },
        { title: 'Pseudoephedrine', category: 'Stimulants', chemicalName: '(1S,2S)-2-(methylamino)-1-phenylpropan-1-ol' },
